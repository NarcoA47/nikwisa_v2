...
//     rating: number | null;
//     reviewsCount: number;
//     // Include other properties of the store you need
//   };
// }
...
//           {store.rating != null && !isNaN(store.rating)
    ...
    <div className="flex flex-col-reverse md:flex-row md:space-x-8 mb-8">
      ...
      <div className="md:w-1/2">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center md:space-x-4">
          ...
          {/* Contact Options */}
          <div className="grid grid-cols-4 gap-2 my-6 w-full md:w-2/3">
            <ContactButton
              icon={FaPhone}
              label="Call"
              onClick={() =>
...
function ContactButton({
  ...
  return (
    <button
      onClick={onClick}
      className="flex flex-col h-16 w-16 md:h-22 md:w-22 items-center justify-center p-4 rounded-lg bg-gray-100 sm:rounded-md sm:border sm:border-gray-300"
    >
